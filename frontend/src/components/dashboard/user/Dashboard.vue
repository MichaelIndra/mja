            ...
            >
              <v-card-text>
                <div class="pa-2">
                  ...
                  >{{ formatPrice(totalOutcomeNow.total) }}</div>
                  ...
                  >{{ formatPrice(totalOutcomePrevious.total) }}</div>
                </div>
              </v-card-text>
            </v-card>
          </v-col>
                ...
                <v-row justify="space-between">
                  <div class="pa-2" style="color: white;font-size: 16px; width: 100%;">
                    ...
                    <div
                      style="font-size: 26px; color: white;"
                      class="font-weight-bold mb-3 ml-9"
                    >{{ formatPrice(totalOvertimeNow.total) }}</div>
                    ...
                    <div
                      style="font-size: 26px; color: white;"
                      class="font-weight-bold mb-1 ml-9"
                    >{{ formatPrice(totalOvertimePrevious.total) }}</div>
                  </div>
                </v-row>
              </v-card-text>
            </v-card>
