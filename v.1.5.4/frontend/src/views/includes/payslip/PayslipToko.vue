      ...
      <v-col>
        <div flat>
          <v-row align="center" justify="space-between">
            <v-col class="py-0">
              <div class="title d-flex flex-row">
                ...
                <div>Data Payslip Toko</div>
              </div>
            </v-col>
            <div class="flex-grow-1"></div>
            <v-col class="text-right py-0">
              <div class="grey--text font-sm">
                {{ convertDate(dateNow, 'long') }}
              </div>
            </v-col>
          </v-row>
          ...
          >
            ...
            <span>Data karyawan yang ditampilkan adalah data karyawan khusus/pimpinan</span>
          </div>-->
          ...
          >
            <v-card-text>
              <div>
                <div
                  class="d-flex flex-row mb-4 align-center justify-space-between"
                >
                  ...
                  <div class="py-0 px-0 d-flex flex-row align-center">
                    <div class="flex-grow-1"></div>
                    <div class="py-0 px-0 d-flex flex-row align-center">
                      <v-tooltip v-if="isHasBeenGenerated(employee)" left>
                        <template v-slot:activator="{ on }">
                          <v-icon large v-on="on" class="mr-2" color="grey"
                            >check_circle</v-icon
                          >
                        </template>
                      ...
                      >
                        <template v-slot:activator="{ on }">
                          <v-icon large v-on="on" class="mr-2" color="green"
                            >check_circle</v-icon
                          >
                        </template>
                ...
                <div class="d-flex flex-row align-center mb-0">
                  <v-col
                    cols="3"
                    class="py-0 px-0 mb-5 d-flex flex-row align-start"
                  >
                    <v-icon
                  ...
                  >
                    <v-icon
                      class="mr-3 box-icon primary lighten-5"
                ...
                ></v-divider>
                <div
                  class="d-flex flex-row justify-space-between align-center my-1"
                >
                  <v-col class="px-0">
                    <v-btn
                ...
                <div class="grid-payslip" v-if="employee">
                  ...
                  <table
                    id="table-payslip"
                    ref="tablePayslip"
                    v-if="$route.params.payslipFilter === '1'"
                  >
                    <tbody>
                      ...
                      <tr class="bo-1 bo-r">
                        ...
                        <td colspan="2">
                          {{ totalWorkDuration.totalWorkDays }} hari
                        </td>
                        <td></td>
                        <td>Total Hari Libur/Tanggal Merah</td>
                        <td colspan="2">
                          {{ totalWorkDuration.totalHolidays }} hari
                        </td>
                      </tr>
                      <tr class="bo-1 bo-r">
                        ...
                        <td colspan="2">
                          {{
                            totalWorkDuration.currentWorkDays > 0
                              ? totalWorkDuration.currentWorkDays
                              : 0
                          }}
                          hari
                        </td>
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td>
                          Potongan Hari Kerja (
                          {{
                            monthlyLeaveDuration > 0
                              ? `${monthlyLeaveDuration / 3600} jam`
                              : ''
                          }}
                          )
                        </td>
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(deductionTotalLeave) }}
                        </td>
                      </tr>
                      <tr class="bo-l bo-r">
                        <!-- <td>Lama Kerja</td>
                        ...
                        <td align="right">
                          ...
                          >
                            <span class="mr-3">{{
                              employee.meta.payslip.lama_kerja &&
                              employee.meta.payslip.lama_kerja !== 0
                                ? formatPrice(employee.meta.payslip.lama_kerja)
                                : formatPrice(workDurationBonus)
                            }}</span>
                            <v-tooltip
                              bottom
                        ...
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(deductionLateCheckin) }}
                        </td>
                      </tr>
                      <tr class="bo-l bo-r">
                        <td>Lembur Extra</td>
                        <td class="bi-b" style="border-bottom: 1px solid #000;">
                          Rp
                        </td>
                        <td
                          class="bi-b"
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td align="right">
                          <strong>
                            {{ formatPrice(oneDayRevenueWeekly) }}
                          </strong>
                        </td>
                        <td></td>
                        <td>Potongan SPSI</td>
                      ...
                      <tr class="bo-l bo-r">
                        <td>
                          Upah 1 minggu ({{ totalWorkDuration.currentWorkDays }}
                          hari masuk)
                        </td>
                        <td>Rp</td>
                        <td align="right">{{ formatPrice(aWeekIncome) }}</td>
                        <td></td>
                        <td>Potongan Bon</td>
                        <td>Rp</td>
                        <td align="right">
                          ...
                          <div
                            v-else-if="
                              totalBonDeductionValue > 0 && !bonDeduction
                            "
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(newWeeklyExtraFull) }}
                        </td>
                        <td colspan="2"></td>
                        <td colspan="2"></td>
                      </tr>
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(weeklySeventhBonus) }}
                        </td>
                        <td colspan="2"></td>
                        <td colspan="2"></td>
                      </tr>
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td align="right">
                          <strong>{{ formatPrice(totalIncomeWeekly) }}</strong>
                        </td>
                        <td></td>
                        <td>
                      ...
                      <tr class="bo-l bo-r bo-t bo-b">
                        ...
                        >
                          <strong>
                            PENDAPATAN GAJI =
                            {{ formatPrice(totalIncomeCleanNumberWeekly) }}
                          </strong>
                        </td>
                      </tr>
                      <tr class="bo-l bo-r bo-t bo-b">
                        <td
                          ...
                          style="background: rgb(225, 225, 225);"
                        >
                          <strong>{{ totalIncomeCleanValueWeekly }}</strong>
                        </td>
                      </tr>
                      <tr class="bo-l bo-r bo-t bo-b">
                        <td
                        ...
                        >
                          <strong
                            >SISA PINJAMAN = Rp{{
                              formatPrice(totalBonDeductionValueNow)
                            }}</strong
                          >
                        </td>
                      </tr>
                  ...
                  <!-- payslip bulanan -->
                  <table id="table-payslip2" ref="tablePayslip" v-else>
                    <tbody>
                      <!-- <tr class="bo-t bo-l bo-r">
                        <td colspan="2"></td>
                        <td colspan="1" class="bi-l"></td>
                      ...
                      <tr class="bo-l bo-r bo-b">
                        <td colspan="7" align="center">
                          Periode {{ getMonthOnly($route.params.dateStart) }}
                        </td>
                      </tr>
                      <tr class="bo-l bo-r">
                        <td colspan="7" align="center"></td>
                      ...
                      <tr class="bo-1 bo-r">
                        ...
                        <td colspan="2">
                          <span class="mr-3"
                            >{{ $route.params.totalDayWorks }} hari</span
                          >
                        </td>
                        <td></td>
                        <td>Total Hari Tidak Masuk</td>
                        <td colspan="2">
                          {{
                            totalDayAbsent.dayLeave > 0
                              ? `${totalDayAbsent.dayLeave} hari`
                              : ''
                          }}
                          {{
                            totalDayAbsent.hourLeave > 0
                              ? `${totalDayAbsent.hourLeave} jam`
                              : ''
                          }}
                        </td>
                      </tr>
                      ...
                      <tr class="bo-l bo-r">
                        ...
                        <td>
                          Potongan Hari Kerja (
                          {{
                            totalWorkNett.leaveDays > 0
                              ? `${totalWorkNett.leaveDays} hari`
                              : ''
                          }}
                          {{
                            totalWorkNett.leaveHours > 0
                              ? `${totalWorkNett.leaveHours} jam`
                              : ''
                          }}
                          )
                        </td>
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(monthlyDayOffDeduction) }}
                        </td>
                      </tr>
                      <tr class="bo-l bo-r">
                        ...
                        <!--<td align="right">{{ formatPrice(0) }}</td>--><!-- set 0 if late calculated as leave-->
                      </tr>
                      <tr class="bo-l bo-r">
                        <td>
                          <strong>Upah 1 hari</strong>
                        ...
                        <td align="right">
                          <strong>{{ formatPrice(oneDayRevenue) }}</strong>
                        </td>
                        <td></td>
                        <td>Pot.BPJS TK & Kesehatan</td>
                        <td>Rp</td>
                      ...
                      <tr class="bo-l bo-r">
                        <td>Insentif Extra
                          ({{monthlyInsentifExtraDuration}})
                        </td>
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(monthlyInsentifExtra) }}
                        </td>
                        <td></td>
                        <td>Potongan SPSI</td>
                        <td>Rp</td>
                      ...
                      <tr class="bo-l bo-r">
                        <td>
                          ...
                          {{
                            `(${totalWorkNett.overtimeDays} hari
                          ${totalWorkNett.overtimeHours} jam)`
                          }}
                        </td>
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(extraWorkAddition) }}
                        </td>
                        <td></td>
                        <td>Potongan Bon</td>
                        <td>Rp</td>
                        <td align="right">
                          ...
                          >
                            ...
                            <template
                              v-if="isEdited && !isHasBeenGenerated(employee)"
                            >
                              <v-icon color="green" @click="changeBonDeduction"
                                >info</v-icon
                              >
                            </template>
                      ...
                      <tr
                        if="employee.area.name.toLowerCase()==='driver'"
                        class="bo-l bo-r"
                      >
                        <td>Tambahan gaji (driver)</td>
                        <td>Rp</td>
                        <td align="right">
                          {{ formatPrice(extraForDriver) }}
                        </td>
                        <td colspan="2"></td>
                        <td colspan="2"></td>
                      </tr>
                      <tr class="bo-l bo-r">
                        ...
                        <td align="right">
                          <strong>
                            {{ formatPrice(totalMonthlyDeduction) }}
                          </strong>
                        </td>
                      </tr>
                      <tr class="bo-l bo-r">
            ...
            <v-card-text>
              <v-row align="center" justify="space-between">
                ...
                <v-col class="py-0 text-right">
                  ...
                  >
                  <v-btn v-else disabled class="elevation-0 ml-3"
                    >Cetak Payslip Tersimpan</v-btn
                  >
              ...
              <div v-if="listPayslip.length <= 0" class="text-center">
                <div
                  class="d-flex flex-row align-start justify-space-between my-10"
                >
                  <img
                    src="../../../assets/logo-payslip.svg"
                    style="width: 12%;"
                  />
                </div>
              ...
              <div v-else>
                <div v-for="(item, index) in listPayslip" :key="index">
                  <div
                    class="d-flex flex-row align-center justify-space-between py-3"
                  >
                    <div>
                      ...
                      <v-tooltip right v-if="item.temp_payslip_data">
                        <template v-slot:activator="{ on }">
                          <v-icon class="ml-3" v-on="on" color="green"
                            >check_circle</v-icon
                          >
                        </template>
                        <span>Data telah disimpan</span>
                      ...
                      <v-tooltip right v-else>
                        <template v-slot:activator="{ on }">
                          <v-icon class="ml-3" v-on="on" color="grey"
                            >cancel</v-icon
                          >
                        </template>
                        <span>Data belum disimpan</span>
          ...
          <v-card
            v-else
            class="round relative card-detail elevation-1 white--text"
          >
            <v-card-text class="text-center py-10">
              <img
                src="../../../../src/assets/empty-state.png"
                class="mb-6"
                alt
              />
              <div class="title black--text my-2">
    ...
    <v-dialog v-model="confirmSetPayslip" persistent width="500">
      <v-card class="custom-modal text-center">
        <v-card-text class="py-5" v-if="employee.temp_payslip_data">
          <div class="title black--text my-2">
            Informasi Perubahan Data Payslip
          </div>
        ...
        <v-card-text class="py-5" v-else>
          ...
          <div>
            Apakah anda yakin ingin menyimpan data payslip karyawan ini?
          </div>
          <div
            class="font-lg my-2 black--text"
            style="border-radius: 7px; padding: 10px 20px; background: #fafafa;"
    ...
    <v-dialog v-model="confirmGeneratePayslip" persistent width="500">
      <v-card class="custom-modal text-center">
        <v-card-text class="py-5">
          ...
          <div class="title black--text my-2 mb-5">
            Konfirmasi Pembuatan Payslip
          </div>
...
<script src="./payslipToko.ts"></script>
