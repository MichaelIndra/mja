...
class EmployeeStatus1575340094197 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query('ALTER TABLE `employees` ADD `status` varchar(50) NOT NULL DEFAULT \'REGULER\'', undefined);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query('ALTER TABLE `employees` DROP COLUMN `status`', undefined);
...
exports.EmployeeStatus1575340094197 = EmployeeStatus1575340094197;
//# sourceMappingURL=1575340094197-EmployeeStatus.js.map