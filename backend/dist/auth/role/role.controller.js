...
], RoleController.prototype, "getMany", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], RoleController.prototype, "getOneAndDoStuff", null);
__decorate([
    role_decorator_1.Roles('admin'),
    crud_1.Override(),
    __param(0, crud_1.ParsedRequest()), __param(1, crud_1.ParsedBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, role_entity_1.Role]),
    __metadata("design:returntype", void 0)
], RoleController.prototype, "createOne", null);
__decorate([
    role_decorator_1.Roles('admin'),
    crud_1.Override(),
    __param(0, crud_1.ParsedRequest()),
    ...
    __metadata("design:returntype", void 0)
], RoleController.prototype, "createMany", null);
__decorate([
    role_decorator_1.Roles('admin'),
    ...
    __metadata("design:paramtypes", [Object, role_entity_1.Role]),
    __metadata("design:returntype", void 0)
], RoleController.prototype, "coolFunction", null);
__decorate([
    role_decorator_1.Roles('admin'),
    ...
    __metadata("design:paramtypes", [Object, role_entity_1.Role]),
    __metadata("design:returntype", void 0)
], RoleController.prototype, "awesomePUT", null);
__decorate([
    role_decorator_1.Roles('admin'),
    crud_1.Override(),
    __param(0, crud_1.ParsedRequest()),
