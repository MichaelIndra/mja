...
let AccountRoleService = class AccountRoleService extends crud_typeorm_1.TypeOrmCrudService {
    constructor(repo) {
        super(repo);
    }
    create(account) {
    ...
    update(id, account) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.repo.update(id, account);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
AccountRoleService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(accountRole_entity_1.AccountRole)),
